...
using Version = Moonlight.Plugins.MinecraftPlugins.ApiClient.Resources.Version;

namespace Moonlight.Plugins.MinecraftPlugins.Services;

public class MinecraftPluginService
{
    private readonly ModrinthApiHelper ModrinthApiHelper;
    private readonly ServerService ServerService;

    public MinecraftPluginService(ModrinthApiHelper modrinthApiHelper)
    {
